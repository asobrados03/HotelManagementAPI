...
public class SqlRoomRepository implements RoomRepository {
    ...
    /**
     * Constructs a new SqlRoomRepository with the specified JDBC template and data source.
     *
     ...
     */
    public SqlRoomRepository(NamedParameterJdbcTemplate namedParameterJdbcTemplate, DataSource dataSource) {
